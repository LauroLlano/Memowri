            ...
            <div class="col">
                <div class="d-flex flex-column min-vh-100 justify-content-center align-items-center">
                    <div class="main-content">
                      <h1>500</h1>
                      <h6>Internal server error - www.memowri.com</h6>
                      <p>{{ $exception!=NULL && $exception->getMessage()!="" ? $exception->getMessage() : "There was an error on the server. Try again later"}}</p>
                    </div>
                </div>
            </div>
        </div>
